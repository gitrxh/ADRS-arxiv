...
class SokobanEnv(BaseDiscreteActionEnv, GymSokobanEnv):
    ...
    def step(self, action: int):
        ...
        step_mode = self.mode if self.mode in ['rgb_array', 'tiny_rgb_array'] else 'tiny_rgb_array'
        _, reward, done, _ = GymSokobanEnv.step(self, action, observation_mode=step_mode)
