#!/bin/bash
# STAR fix5 on SearchQA -- Qwen2.5-7B-Instruct
...
experiment_name="grpo_star_fix5${GATE_TAG}${RTG_TAG}${CLIP_TAG}${SIGN_TAG}${ENT_TAG}${ADAPT_TAG}${KLBOOST_TAG}${MODE_TAG}${NEGRESET_TAG}_search_qwen2.5_7b_eta${adrs_eta}_${timestamp}"
...
# ============================================================
# 6. Training -- fix5, Qwen2.5-7B
# ============================================================
echo "[$(date)] Starting GRPO-STAR fix5 SearchQA 7B: $experiment_name"
