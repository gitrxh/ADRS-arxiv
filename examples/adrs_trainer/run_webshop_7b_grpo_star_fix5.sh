...
# STAR fix5: fix4 + entropy protection (wn_clip + 3-phase schedule) — Qwen2.5-7B
...
experiment_name="grpo_star_fix5${GATE_TAG}${RTG_TAG}${CLIP_TAG}${SIGN_TAG}${ENT_TAG}_webshop_qwen2.5_7b_eta${adrs_eta}_${timestamp}"
