...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, lam=1.0, num_repeat=1, multi_turn=False, norm_adv_by_std_in_grpo=True, step_advantage_w=1.0, gigpo_mode="mean_std_norm", gigpo_enable_similarity=False, gigpo_similarity_thresh=0.95, eta=0.0, teacher_reward=None, wn_clip=0.0, wn_sign=1.0, wn_adaptive_clip=False, wn_mode="additive", student_log_probs=None, teacher_log_probs=None, wn_neg_reset=False, **kwargs):
    ...
    if adv_estimator == AdvantageEstimator.GAE:
        ...
        advantages, returns = core_algos.compute_grpo_outcome_advantage(
            ...
            wn_clip=wn_clip,
            wn_sign=wn_sign,
            wn_adaptive_clip=wn_adaptive_clip,
            wn_mode=wn_mode,
            student_log_probs=student_log_probs,
            teacher_log_probs=teacher_log_probs,
            wn_neg_reset=wn_neg_reset,
        )
        data.batch["advantages"] = advantages
        data.batch["returns"] = returns
