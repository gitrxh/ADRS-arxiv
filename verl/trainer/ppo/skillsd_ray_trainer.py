...
class SkillSDRayTrainer(RLSDRayTrainer):
    ...
    def _post_advantage_hook(self, batch, metrics: dict):
        """Hook for subclass advantage shaping. Override in PARSRayTrainer."""
            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("adv", timing_raw):
                        ...
                        # Hook for subclass advantage shaping (e.g., PARS)
